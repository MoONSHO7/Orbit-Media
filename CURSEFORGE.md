...
Optional artwork for World of Warcraft addons: **40 animated icon glows, 82 status-bar textures and seven border styles**.
Orbit is optional. Compatible addons supply LibOrbitGlow or LibSharedMedia and expose the artwork in their own settings.

**[Browse the interactive gallery](https://moonsho7.github.io/Orbit-Media/)** to try colors, corners, animation speeds, fill levels and resizable nine-slice borders.
...
The pack registers its artwork when the required library becomes available; it does not bundle a rendering engine.
